...
import { SERVER_URL } from "../../constant"; // ✅ constant.js에서 API_URL 가져오기
...
export default function ChatModal({ open, onClose, chatRoom }) {
    ...
    useEffect(() => {
        ...
        // ✅ WebSocket URL도 constant.js에서 가져오기
    ...
    const fetchChatMessages = async () => {
        try {
            const response = await fetchWithAuth(`/chat/messages/${chatRoom.id}`);
            if (response.ok) {
