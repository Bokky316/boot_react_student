...
public class MessageService {
     ...
     * ✅ 사용자가 보낸 메시지 조회
     */
    public List<Message> getSentMessages(Long memberId) {
     ...
     * ✅ 사용자가 받은 메시지 조회
     */
    public List<Message> getReceivedMessages(Long memberId) {
    ...
    public List<MessageResponseDto> getMessagesByUserId(Long memberId) {
    ...
    /**
     * 초대 메시지 개수 조회 (내용에 '초대'가 포함된 메시지만 필터링)
     */
    //public int getInvitationMessagesCount(Long memberId) {
    //    return messageRepository.countChatInvitationsByMemberId(memberId, "초대");
    //}
